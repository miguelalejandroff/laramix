...
namespace Miguelalejandroff\Laravel\Ifx\Eloquent;

use Miguelalejandroff\Laravel\Ifx\Connection;
use Miguelalejandroff\Laravel\Ifx\Query\Builder as QueryBuilder;
use Miguelalejandroff\Laravel\Ifx\Query\Grammars\Grammar;
...
class Eloquent extends Model
{
    ...
    {
        $binaries = [];
        if ($this->checkBinary($attributes) && $this->getConnection() instanceof Connection) {
     ...
     *
     * @return IlluminateQueryBuilder|QueryBuilder
     */
